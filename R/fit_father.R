...
saveRDS(fit, "stanfits/father_survival.rds")
...
fit <- rstan::read_stan_csv(fit$output_files())
saveRDS(fit, "stanfits/father_height.rds")
...
fit <- rstan::read_stan_csv(fit$output_files())
saveRDS(fit, "stanfits/father_weight.rds")
...
fit <- rstan::read_stan_csv(fit$output_files())
saveRDS(fit, "stanfits/father_education.rds")
