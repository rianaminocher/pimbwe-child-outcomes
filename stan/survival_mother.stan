...
array [9] vector [A] a_age_raw;
vector <lower = 0, upper = 1> [9] a_age_kappa;
vector <lower = 0> [9] a_age_tau;
vector <lower = 0> [9] a_age_delta;
...
generated quantities {
  ...
  array [2] vector [A] p_mother_dead;
  array [2] vector [A] p_mother_unmarried;
  array [2] vector [A] p_mother_married_to_notfather;
  array [2] vector [A] p_mother_married_to_father_with_cowife;
